...
Original file is located at
    https://colab.research.google.com/drive/1mHgF2xJCl_VDGEWGC02G6uVVdY1NsZWx
"""
...
df = pd.read_csv(io.BytesIO(uploaded['preprocessref_complete.csv'])) 
print(df)
...
print("the lenght of de X_train is", len(X_train))
...
test_model = load_model('working/model_BaseLSTM_0.915.h5')
...
plt.figure(figsize=(16,7))
sns.heatmap(precision, cmap = "Blues", annot = True, fmt = ".2f", xticklabels=labels, yticklabels=labels, cbar=false)
...
plt.figure(figsize=(16,7))
sns.heatmap(recall, cmap = "Blues", annot = True, fmt = ".2f", xticklabels=labels, yticklabels=labels, cbar=false)
...
from keras.models import load_model
test_model = load_model('working/model_multi_LSTM_0.800.h5')
