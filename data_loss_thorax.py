...
data = pd.read_csv('3m_3.txt', sep=",|:", header=None, engine='python')
...
data_2 = data_2.iloc[:(max_value + 1) * 256]
...
data_3 = data_3.iloc[:(max_value + 1) * 256]'''
...
nan_T = tor['quat1_1'].isna().sum()-1  # subtracting the first nan data_1[1], beacuse it is written by the algorithm when it fix the order
